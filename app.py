...
from utils.transformations import get_list_with_removed_colums, adding_prime_columns, get_prime_columns, adding_pm_pr
...
def main():
    ...
    with col1:
        uploaded_file = st.file_uploader("Choose your xlsx file, it must contain at least 'Articles' & 'MO' columns", type="xlsx")
